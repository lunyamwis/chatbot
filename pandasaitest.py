...
def vehicle_enquiry_agent(user_message=None) -> str:
    ...
    If `{user_message}` indicates that the user is sharing their budget in terms of numeric value greater than 0. Trigger the `negotiate_car_price` tool to find out the lowest price.
